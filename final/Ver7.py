#while add this script to systemctl on 192.168.1.59 change python3 to python2 in dummy.service file 
import json
import time
...
def fun1():
    ...
    while a <2:
        for Temperature,Vibration,Acceleration in x1:
            ...
            sql = "INSERT INTO prusight_dv_vibration_sensor_1(temperature_value, velocity_value, acceleration_value, timestamp_value) VALUES ('%s','%s','%s','%s')" % (Temperature,Acceleration,Vibration,time_now)
